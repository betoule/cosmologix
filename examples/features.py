...
contours.plot_contours(grid0, filled=True, ax=axes[1,1], label='CMB', base_color=display.color_theme[1])
contours.plot_contours(grid1, filled=True, ax=axes[1,1], label='SN', base_color=display.color_theme[2])
contours.plot_contours(grid, filled=False, label='CMB+SN', ax=axes[1,1], base_color=display.color_theme[0])
plt.ion()
