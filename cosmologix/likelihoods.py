...
class GeometricCMBLikelihood(Chi2FullCov):
    ...
    def model(self, params):
        ...
        params["100theta_star"] = acoustic_scale.theta_star(params)
        params["theta_star"] = params["100theta_star"] / 100.0
...
def DESIDR2(uncalibrated=False):
    ...
    desi2025_prior = Prior(
        ...
        covariance=[
            [0.075**2] + [0] * 12,
            [0, 0.167**2, -0.459 * 0.167 * 0.425] + [0] * 10,
            [0, -0.459 * 0.167 * 0.425, 0.425**2] + [0] * 10,
            [0] * 3 + [0.177**2, -0.404 * 0.177 * 0.330] + [0] * 8,
            [0] * 3 + [-0.404 * 0.177 * 0.330, 0.330**2] + [0] * 8,
            [0] * 5 + [0.152**2, -0.416 * 0.152 * 0.193] + [0] * 6,
            [0] * 5 + [-0.416 * 0.152 * 0.193, 0.193**2] + [0] * 6,
            [0] * 7 + [0.318**2, -0.434 * 0.321 * 0.217] + [0] * 4,
            [0] * 7 + [-0.434 * 0.318 * 0.221, 0.221**2] + [0] * 4,
            [0] * 9 + [0.760**2, -0.500 * 0.760 * 0.516] + [0] * 2,
            [0] * 9 + [-0.500 * 0.760 * 0.516, 0.516**2] + [0] * 2,
